...
public class NearHelmListAdapter extends RecyclerView.Adapter<NearHelmListAdapter.MyViewHolder> {
    ...
    public NearHelmListAdapter(Context context, List<Helm> merchantList) {
        this.merchantList = merchantList;
        this.context = context;


    }
    public NearHelmListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(NearHelmListAdapter.MyViewHolder holder, int position) {
